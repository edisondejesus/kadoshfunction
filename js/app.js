...
Vue.component('citas',{
	...
	<div class="panel panel-default">	
		<div class="panel-body">
			...
			<button class="btn btn-primary" v-on:click="add_function(data.id_cita)">Procesesar</button>
					</div>
				</div>
	</div >
...
Vue.component('edison',{

	props:['numero','numero2'],
	template:`
		<h1> {{  parseInt(numero) + parseInt(numero2) }}</h1>
	`,
